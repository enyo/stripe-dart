...
void main() {
  group('CustomerEvent', () {
    test('properly decodes all values', () async {
      final message = CustomerEvent.fromJson(eventObject);
...
const Map<String, Object> eventObject = {
  ...
  'data': {
    'object': {
      ...
      'name': null,
      'phone': null,
      // this is test api data, we won't always know type
  ...
  'livemode': false,
  'pending_webhooks': 1,
  'request': {'id': 'req_TXqqnYLKGM0xMT', 'idempotency_key': null},
